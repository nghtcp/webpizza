...
<html lang="en">
  ...
  <body>
    ...
    <header>
      <div class="jumbotron" style="background-image: url(..\images\bg_2.jpg)">
        <div class="container">
          <div class="row">
            <div class="col-12">
              <h1 class="text-center">PIZZA CAMERANA</h1>
              ...
              <p>&nbsp;</p>
              <p class="text-center"><a class="btn btn-primary btn-lg" href="#" role="button">Login</a></p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section>
      ...
      <div class="jumbotron">
        <div class="container">
          ...
          <div class="row">
            <div class="col-sm-4 col-auto mx-auto"><a class="btn btn-block btn-lg btn-success" href="#">Registrati</a></div>
          </div>
        </div>
      </div>
      <div class="container">
